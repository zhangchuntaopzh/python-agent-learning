...
export type WaitForDepositStatusTimeoutErrorType = WaitForDepositStatusTimeoutError & {
    name: 'WaitForDepositStatusTimeoutError';
};
export declare class WaitForDepositStatusTimeoutError extends BaseError {
