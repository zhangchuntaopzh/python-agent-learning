...
import { type WaitForDepositStatusTimeoutErrorType } from '../errors.js';
 ...
 */
export declare function waitForDepositStatus<chain extends Chain | undefined, account extends Account | undefined>(client: Client<Transport, chain, account>, parameters: waitForDepositStatus.Parameters): Promise<waitForDepositStatus.ReturnType>;
export declare namespace waitForDepositStatus {
    type Parameters = getDepositStatus.Parameters & {
        /** Polling frequency in milliseconds. @default `client.pollingInterval` */
        pollingInterval?: number | undefined;
        /** Timeout in milliseconds. @default `60_000` */
        timeout?: number | undefined;
    };
    type ReturnType = getDepositStatus.ReturnType;
    type ErrorType = getDepositStatus.ErrorType | ObserveErrorType | PollErrorType | WaitForDepositStatusTimeoutErrorType;
}
/**
