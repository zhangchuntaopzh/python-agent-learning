...
exports.FeeTokenPausedError = exports.FeeTokenNotUsdError = exports.FeeTokenNotTip20Error = exports.InvalidFeeTokenError = exports.WaitForDepositStatusTimeoutError = void 0;
const base_js_1 = require("../errors/base.js");
class WaitForDepositStatusTimeoutError extends base_js_1.BaseError {
    constructor({ tempoBlockNumber }) {
        super(`Timed out while waiting for deposits from Tempo block "${tempoBlockNumber}" to be processed.`, { name: 'WaitForDepositStatusTimeoutError' });
    }
}
exports.WaitForDepositStatusTimeoutError = WaitForDepositStatusTimeoutError;
